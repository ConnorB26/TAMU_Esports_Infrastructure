...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      ...
      <Container fluid className={`py-4 ${styles.followUsWrapper}`}>
        <Container>
          <Row className="justify-content-around">
            ...
            <InViewMotionDiv
              className={`col-md-6 col-sm-12 ${styles.twitterColumn}`}
              variants={{
      ...
      {/*
        White spacer section replacing the old Partners area.
        Adjust minHeight as needed to match previous visual height.
      */}
      <Container
        className="py-5"
        style={{ backgroundColor: '#ffffff', minHeight: 280 }}
      >
        {/* Intentionally empty to preserve layout space */}
      </Container>
    </>
  );
};
